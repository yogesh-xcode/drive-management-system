...
export default function HomePage() {
  return (
    <main className="min-h-[100dvh] bg-background px-4 py-6 lg:px-6">
      <div className="mx-auto flex min-h-[calc(100dvh-3rem)] w-full max-w-[900px] items-center">
        <section className="grid w-full min-w-0  overflow-hidden rounded-3xl border border-border bg-background text-foreground shadow-sm lg:grid-cols-2">
